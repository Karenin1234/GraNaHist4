...
class Player:
    def __init__(self):
        ...
        self.image = pygame.image.load("stand.png")  # wczytuje grafikę
...
def main():
    ...
    tekst=pygame.font.Font.render(pygame.font.SysFont('arial', 40),str(score), True, (0,0,0))
    while run:
        ...
        tekst=pygame.font.Font.render(pygame.font.SysFont('arial', 40), f'wynik: {score}', True, (0, 0, 0))
